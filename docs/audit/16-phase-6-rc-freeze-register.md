...
| RC1-006 | iOS IPA export readiness | export template plus owner signing path | `mobile/ios/ExportOptions.plist.template` exists; IPA missing until Apple Team ID/signing | BLOCKED_EXTERNAL |
...
| RC1-016 | final release manifest | manifest generated after RC1 build | `docs/release-artifacts-manifest.md` generated; AAB/APK/archive found, IPA missing | GO |
