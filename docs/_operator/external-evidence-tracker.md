# HiAir External Evidence Tracker

Last updated: 2026-04-22

This tracker defines the minimum evidence package required to close each external blocker issue.
...
- External proof request packet: `docs/_operator/external-proof-request-packet.md`
