...
enum HiAirL10n {
    ...
    private static let baseStrings: [String: [String: String]] = [
        "ru": [
            ...
            "wearable.consent.body": "HiAir сможет точнее оценивать нагрузку на организм во время жары и плохого воздуха. Мы можем учитывать шаги, пульс и пульс в покое.",
            ...
            "common.city_updated": "Обновляется автоматически",
            ...
            "dashboard.reason_code": "Объяснение риска появится после загрузки данных.",
            "dashboard.reason_unavailable": "Объяснение пока недоступно.",
            "dashboard.tomorrow_hint": "",
            ...
            "dashboard.source_sample": "Демонстрационные условия",
            ...
            "paywall.products_unavailable": "Планы недоступны в App Store. Подписки ещё не привязаны к сборке в App Store Connect.",
            ...
            "paywall.asc_hint": "Нужны продукты com.hiair.premium.monthly и .yearly в App Store Connect, привязанные к версии приложения в TestFlight.",
        ...
        "en": [
            ...
            "wearable.consent.body": "HiAir can better estimate your body load during heat and poor air. We may use steps, heart rate, and resting heart rate.",
            ...
            "common.city_updated": "Updates automatically",
            ...
            "dashboard.reason_code": "Risk explanation appears after data loads.",
            ...
            "dashboard.source_sample": "Sample conditions",
            "dashboard.metric.aqi": "AQI",
            "dashboard.metric.pm25": "PM2.5",
            ...
            "paywall.products_unavailable": "Plans are unavailable from the App Store. Subscriptions may not be linked to this build in App Store Connect.",
            ...
            "paywall.asc_hint": "Requires com.hiair.premium.monthly and .yearly in App Store Connect, linked to the app version on TestFlight.",
            "paywall.retry": "Retry",
