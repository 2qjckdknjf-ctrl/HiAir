...
enum HiAirL10n {
    ...
    private static let baseStrings: [String: [String: String]] = [
        "ru": [
            ...
            "settings.places.limit_reached": "Лимит сохранённых мест. Оформите Premium для большего числа локаций.",
            ...
            "settings.travel.title": "Режим путешествия",
            "settings.travel.subtitle": "Временно использовать сохранённое место для воздуха и риска",
            "settings.travel.active": "Активно: %@",
            "settings.travel.inactive": "Сейчас используется домашний профиль",
            "settings.travel.select_place": "Место",
            "settings.travel.start": "Включить travel",
            "settings.travel.end": "Завершить travel",
            "settings.travel.need_place": "Сначала сохраните место",
            "settings.travel.started": "Travel включён",
            "settings.travel.ended": "Travel выключен",
            "settings.travel.start_failed": "Не удалось включить travel",
            "settings.travel.end_failed": "Не удалось выключить travel",
            "settings.travel.load_failed": "Не удалось загрузить travel",
            ...
            "insights.adaptation.protected.empty": "Пока нет подтверждённых защищённых дней.",
            "insights.adaptation.association_not_causation": "Ассоциация, не причинность — без медицинских выводов.",
            ...
            "dashboard.tooltip.no2": "Диоксид азота от транспорта и отопления может раздражать дыхательные пути.",
            ...
            "settings.work.wbgt_estimated_disclaimer": "WBGT оценён по метеоданным — не измерение на площадке",
            ...
            "dashboard.travel.title": "Режим путешествия",
            "dashboard.travel.active": "Сейчас: %@",
            "dashboard.travel.subtitle": "Риск и прогноз считаются для этого места",
            "dashboard.travel.place_fallback": "сохранённое место",
            "settings.work.wbgt_estimated_disclaimer": "WBGT оценён по метеоданным — не измерение на площадке",
        ...
        "en": [
            ...
            "settings.places.limit_reached": "Saved place limit reached. Upgrade to Premium for more locations.",
            ...
            "settings.travel.title": "Travel mode",
            "settings.travel.subtitle": "Temporarily use a saved place for air and risk",
            "settings.travel.active": "Active: %@",
            "settings.travel.inactive": "Using home profile now",
            "settings.travel.select_place": "Place",
            "settings.travel.start": "Start travel",
            "settings.travel.end": "End travel",
            "settings.travel.need_place": "Save a place first",
            "settings.travel.started": "Travel started",
            "settings.travel.ended": "Travel ended",
            "settings.travel.start_failed": "Could not start travel",
            "settings.travel.end_failed": "Could not end travel",
            "settings.travel.load_failed": "Could not load travel",
            ...
            "insights.adaptation.protected.empty": "No confirmed protected days yet.",
            "insights.adaptation.association_not_causation": "Association, not causation — no medical conclusions.",
            ...
            "dashboard.tooltip.no2": "Nitrogen dioxide from traffic and heating can irritate airways.",
            ...
            "settings.work.wbgt_estimated_disclaimer": "WBGT estimated from weather data — not on-site instrument reading",
            ...
            "dashboard.travel.title": "Travel mode",
            "dashboard.travel.active": "Active: %@",
            "dashboard.travel.subtitle": "Risk and forecast use this place",
            "dashboard.travel.place_fallback": "saved place",
            "settings.work.wbgt_estimated_disclaimer": "WBGT estimated from weather data — not on-site instrument reading",
    ...
    private static let localizedOverrides: [String: [String: String]] = [
        "es": [
            ...
            "settings.places.limit_reached": "Límite de lugares alcanzado. Pásate a Premium para más ubicaciones.",
            ...
            "settings.travel.title": "Modo viaje",
            "settings.travel.subtitle": "Usar temporalmente un lugar guardado para aire y riesgo",
            "settings.travel.active": "Activo: %@",
            "dashboard.travel.title": "Modo viaje",
            "dashboard.travel.active": "Activo: %@",
            "dashboard.travel.subtitle": "El riesgo y el pronóstico usan este lugar",
            "dashboard.travel.place_fallback": "lugar guardado",
            "settings.work.wbgt_estimated_disclaimer": "WBGT estimado con datos meteorológicos — no es medición en obra",
            "settings.travel.inactive": "Ahora se usa el perfil de casa",
            "settings.travel.select_place": "Lugar",
            "settings.travel.start": "Activar viaje",
            "settings.travel.end": "Terminar viaje",
            "settings.travel.need_place": "Guarda un lugar primero",
            "settings.travel.started": "Viaje activado",
            "settings.travel.ended": "Viaje desactivado",
            "settings.travel.start_failed": "No se pudo activar el viaje",
            "settings.travel.end_failed": "No se pudo desactivar el viaje",
            "settings.travel.load_failed": "No se pudo cargar el modo viaje",
            ...
            "insights.adaptation.protected.empty": "Aún no hay días protegidos confirmados.",
            "insights.adaptation.association_not_causation": "Asociación, no causalidad — sin conclusiones médicas.",
        ...
        "it": [
            ...
            "settings.places.limit_reached": "Limite luoghi raggiunto. Passa a Premium per più posizioni.",
            ...
            "settings.travel.title": "Modalità viaggio",
            "settings.travel.subtitle": "Usa temporaneamente un luogo salvato per aria e rischio",
            "settings.travel.active": "Attivo: %@",
            "dashboard.travel.title": "Modalità viaggio",
            "dashboard.travel.active": "Attivo: %@",
            "dashboard.travel.subtitle": "Rischio e previsione usano questo luogo",
            "dashboard.travel.place_fallback": "luogo salvato",
            "settings.work.wbgt_estimated_disclaimer": "WBGT stimato da dati meteo — non misura strumentale in cantiere",
            "settings.travel.inactive": "Ora si usa il profilo casa",
            "settings.travel.select_place": "Luogo",
            "settings.travel.start": "Avvia viaggio",
            "settings.travel.end": "Termina viaggio",
            "settings.travel.need_place": "Salva prima un luogo",
            "settings.travel.started": "Viaggio avviato",
            "settings.travel.ended": "Viaggio terminato",
            "settings.travel.start_failed": "Impossibile avviare il viaggio",
            "settings.travel.end_failed": "Impossibile terminare il viaggio",
            "settings.travel.load_failed": "Impossibile caricare la modalità viaggio",
            ...
            "insights.adaptation.protected.empty": "Nessun giorno protetto confermato.",
            "insights.adaptation.association_not_causation": "Associazione, non causalità — nessuna conclusione medica.",
        ...
        "fr": [
            ...
            "settings.places.limit_reached": "Limite de lieux atteinte. Passez a Premium pour plus d'emplacements.",
            ...
            "settings.travel.title": "Mode voyage",
            "settings.travel.subtitle": "Utiliser temporairement un lieu enregistre pour l'air et le risque",
            "settings.travel.active": "Actif : %@",
            "dashboard.travel.title": "Mode voyage",
            "dashboard.travel.active": "Actif : %@",
            "dashboard.travel.subtitle": "Le risque et la prévision utilisent ce lieu",
            "dashboard.travel.place_fallback": "lieu enregistré",
            "settings.work.wbgt_estimated_disclaimer": "WBGT estimé à partir des données météo — pas une mesure instrumentale sur site",
            "settings.travel.inactive": "Profil domicile utilise actuellement",
            "settings.travel.select_place": "Lieu",
            "settings.travel.start": "Demarrer le voyage",
            "settings.travel.end": "Terminer le voyage",
            "settings.travel.need_place": "Enregistrez d'abord un lieu",
            "settings.travel.started": "Voyage demarre",
            "settings.travel.ended": "Voyage termine",
            "settings.travel.start_failed": "Impossible de demarrer le voyage",
            "settings.travel.end_failed": "Impossible de terminer le voyage",
            "settings.travel.load_failed": "Impossible de charger le mode voyage",
            ...
            "insights.adaptation.protected.empty": "Aucun jour protege confirme.",
            "insights.adaptation.association_not_causation": "Association, pas causalite — aucune conclusion medicale.",
...
extension Notification.Name {
    static let hiairTravelSessionDidChange = Notification.Name("hiairTravelSessionDidChange")
}
