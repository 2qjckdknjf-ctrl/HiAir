...
enum HiAirL10n {
    ...
    private static let baseStrings: [String: [String: String]] = [
        "ru": [
            ...
            "insights.progress_days": "%d из %d дней",
            ...
            "insights.section.trends": "Ваши тренды",
            "insights.section.trends.empty": "Пока недостаточно данных для трендов.",
            "insights.section.associations": "Возможные связи",
            ...
            "insights.health_status": "Дней с метриками: %d · синхронизация: %@",
            "insights.health_status_unknown": "Статус синхронизации пока неизвестен.",
        ...
        "en": [
            ...
            "insights.progress_days": "%d of %d days",
            ...
            "insights.section.trends": "Your trends",
            "insights.section.trends.empty": "Not enough data for trends yet.",
            "insights.section.associations": "Possible associations",
            ...
            "insights.health_status": "Metric days: %d · sync: %@",
            "insights.health_status_unknown": "Sync status is not known yet.",
