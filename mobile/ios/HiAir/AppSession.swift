...
enum HiAirL10n {
    ...
    private static let baseStrings: [String: [String: String]] = [
        "ru": [
            ...
            "wearable.dashboard.denied": "Доступ к health-данным отключён. Вы можете включить его в настройках.",
        ...
        "en": [
            ...
            "wearable.dashboard.denied": "Health access is off. You can enable it in Settings.",
    ...
    private static let localizedOverrides: [String: [String: String]] = [
        "es": [
            ...
            "wearable.dashboard.denied": "Acceso a salud desactivado. Puedes activarlo en Ajustes.",
