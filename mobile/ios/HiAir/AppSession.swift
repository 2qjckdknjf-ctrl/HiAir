...
enum HiAirL10n {
    ...
    private static let baseStrings: [String: [String: String]] = [
        "ru": [
            ...
            "auth.oauth_continue": "Продолжите вход через Google в HiAir.",
            ...
            "auth.legal": "Регистрация означает согласие с Условиями и Политикой конфиденциальности.",
            ...
            "onboarding.for_child": "Прогулки с детьми (аккаунт 13+)",
            ...
            "onboarding.permissions.allow": "Продолжить",
            "onboarding.permissions.later": "Продолжить",
            ...
            "wearable.consent.skip": "Продолжить",
            ...
            "settings.subtitle": "Управляйте уведомлениями, подпиской и профилем.",
            ...
            "paywall.legal_auto_renew": "Подписка автопродлевается, пока не отменить. Оплата списывается с Apple ID. Управлять или отменить: Настройки → Подписка или кнопка «Управлять подпиской».",
            "paywall.required_info": "Подписка HiAir Premium",
            "paywall.service_period": "Премиум-инсайты, планировщик и отчёты в каждом периоде подписки.",
            "paywall.price_per_month": "≈ %@ / месяц",
            "paywall.offer_title_monthly": "HiAir Premium Monthly",
            "paywall.offer_title_yearly": "HiAir Premium Yearly",
            "paywall.length_month": "Период обслуживания: 1 месяц",
            "paywall.length_year": "Период обслуживания: 1 год",
            ...
            "onboarding.date_of_birth.body": "Нужна для персональных рекомендаций. Аккаунт HiAir только для пользователей 13+.",
            "onboarding.age_requirement": "HiAir доступен с 13 лет.",
            ...
            "settings.support_email": "Написать в поддержку: hello@hiair.io",
            "settings.support_site": "Сайт и помощь: hiair.io",
            "settings.delete_account_warning": "Удаление стирает аккаунт HiAir и связанные данные. Подписка Apple продолжает списываться, пока вы не отмените её в App Store → Подписки.",
            ...
            "settings.account_delete_cancelled": "Удаление аккаунта отменено.",
            "settings.delete_account_confirm_title": "Удалить аккаунт?",
            "settings.delete_account_confirm_body": "Это действие необратимо. Подписка Apple может продолжать списываться, пока вы не отмените её в настройках Apple ID. Для аккаунтов Apple потребуется повторный вход через Apple.",
            "settings.delete_account_confirm_action": "Удалить навсегда",
        ...
        "en": [
            ...
            "auth.oauth_continue": "Continue Google sign-in in HiAir.",
            ...
            "auth.legal": "By creating an account you agree to the Terms and Privacy Policy.",
            ...
            "onboarding.for_child": "Outdoor guidance for children I care for (account holder 13+)",
            ...
            "onboarding.permissions.allow": "Continue",
            "onboarding.permissions.later": "Continue",
            ...
            "wearable.consent.skip": "Continue",
            ...
            "settings.subtitle": "Manage notifications, subscription, and profile.",
            ...
            "paywall.legal_auto_renew": "Subscriptions auto-renew until cancelled. Payment is charged to your Apple ID. Manage or cancel in Settings → Subscriptions or via Manage subscription.",
            "paywall.required_info": "HiAir Premium subscription",
            "paywall.service_period": "Premium insights, planner, and reports during each subscription period.",
            "paywall.price_per_month": "≈ %@ / month",
            "paywall.offer_title_monthly": "HiAir Premium Monthly",
            "paywall.offer_title_yearly": "HiAir Premium Yearly",
            "paywall.length_month": "Service period: 1 month",
            "paywall.length_year": "Service period: 1 year",
            ...
            "onboarding.date_of_birth.body": "Used for age-aware wellness guidance. HiAir accounts are for users 13+.",
            "onboarding.age_requirement": "HiAir is available to users 13 and older.",
            "common.close": "Close",
            ...
            "settings.support_email": "Email support: hello@hiair.io",
            "settings.support_site": "Website and help: hiair.io",
            "settings.delete_account_warning": "This permanently deletes your HiAir account and stored data. Apple subscriptions keep billing until you cancel in App Store → Subscriptions.",
            ...
            "settings.account_delete_cancelled": "Account deletion was cancelled.",
            "settings.delete_account_confirm_title": "Delete account?",
            "settings.delete_account_confirm_body": "This action is permanent. Apple billing may continue until you cancel the subscription in Apple ID settings. Apple accounts require Sign in with Apple reauthentication.",
            "settings.delete_account_confirm_action": "Delete permanently",
    ...
    private static let localizedOverrides: [String: [String: String]] = [
        "es": [
            ...
            "wearable.consent.skip": "Continuar",
            ...
            "settings.support_email": "Soporte: hello@hiair.io",
            "settings.support_site": "Web y ayuda: hiair.io",
