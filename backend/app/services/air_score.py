...
def to_air_environment(
    ...
    return EnvironmentalInput(
        ...
        no2=float(environment.no2) if environment.no2 is not None else None,
        uv=environment.uv,
        wind_speed=environment.wind_speed,
        pollen_grains_m3=environment.pollen_grains_m3,
        wildfire_pm10=environment.wildfire_pm10,
