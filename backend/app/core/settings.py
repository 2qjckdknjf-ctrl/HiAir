...
class Settings:
    ...
    apple_team_id: str = os.getenv("APPLE_TEAM_ID", "43A4KW5BKB").strip()
    apple_sign_in_key_id: str = os.getenv("APPLE_SIGN_IN_KEY_ID", "8BXW8SG2B4").strip()
    apple_services_id: str = os.getenv("APPLE_SERVICES_ID", "com.hiair.app.auth").strip()
    apple_sign_in_p8_path: str = os.getenv("APPLE_SIGN_IN_P8_PATH", "").strip()
