...
- For HiAir readiness and audit work, user prefers evidence-first findings with file paths, concrete blockers, and clear status vocabulary such as DONE, PARTIAL, MISSING, BLOCKED, RISK, and CRITICAL.
